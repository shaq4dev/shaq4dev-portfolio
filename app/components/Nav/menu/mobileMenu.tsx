...
const MobileMenu = ({
  ...
  return (
    <>
      ...
      />
        ...
        `}>
            ...
            <ul className="px-5 flex flex-col gap-4">
...

                {
                    menuObject.map(item => (
                        <div key={item.id} className='w-full'>
                            <Link href={item.url} className='w-full px-3 py-3 group flex capitalize items-center justify-between hover:bg-purple-100 cursor-pointer duration-200'>
                ...
                <button className='w-full  block px-3 py-3' onClick={() => dispatch({type: 'trigger'})}>
                  <div className={`${theme === 'light' ? 'text-dark-primary' : 'text-light-primary'}`}>
                      {
                          theme === 'light' ?
      ...
      {/*      <button className='px-8 py-5' onClick={() => dispatch({type: 'trigger'})}>*/}
      {/*          <div className={`${theme === 'light' ? 'text-dark-primary' : 'text-light-primary'}`}>*/}
      {/*              {*/}
