export const projects = [
    {
        ...
        image_url: "https://cdn.pixabay.com/photo/2017/11/13/22/12/compass-2946959_1280.jpg",
        projectType: "web",
        description:
    ...
    },
    {
        ...
        image_url: "https://cdn.pixabay.com/photo/2016/11/29/12/51/adult-1869621_1280.jpg",
        projectType: "web",
        description:
    ...
    },
    {
        ...
        image_url: "https://cdn.pixabay.com/photo/2018/03/30/06/55/modern-3274548_1280.jpg",
        projectType: "web",
        description:
    ...
    },
    {
        ...
        image_url: "https://cdn.pixabay.com/photo/2024/10/12/03/15/women-9114238_1280.jpg",
        projectType: "ux",
        description:
    ...
    },
    {
        ...
        image_url: "https://cdn.pixabay.com/photo/2015/01/15/16/17/hands-600497_1280.jpg",
        projectType: "web",
        description:
    ...
    },
    {
        ...
        image_url: "https://cdn.pixabay.com/photo/2014/10/27/07/40/swimming-pool-504780_1280.jpg",
        projectType: "ux",
        description:
    ...
    },
    {
        ...
        label: "MMM",
        url: "https://www.figma.com/proto/Hubuch7id0HaY4A3sY7WgU/Carlton-Pools---Hero?node-id=0-3&p=f&t=wLiXlS9vzkR3jveu-0&scaling=scale-down&content-scaling=fixed&page-id=0%3A1&starting-point-node-id=0%3A3",
        image_url: "https://cdn.pixabay.com/photo/2024/12/27/14/58/owl-9294302_1280.jpg",
        projectType: "ux",
        description:
            "Created for SwimSEO, with the target audience being Boomers to Gen X, my overall approach is to prioritize clarity, accessibility and ease of use. This will mean: The use of larger font sizes and high contrast text, The use of san-serif fonts, in this case it’s Roboto, for legibility...",
        technologies: ["figma"],
